...
export default function VideoPlayerLoading() {
    const { status, isPlaying, isLoading, handlePlay } = useVideoPlayer();

    return (
        <div className="absolute top-0 left-0 flex h-full w-full items-center justify-center">
            <div className="flex h-full flex-1 items-center justify-center"></div>
            <div
                className={cn(
                    "flex h-full flex-1 items-center justify-center transition-all",
